...
// XXX we duplicate this code in deploy.js. Maybe this should
// go in some fiber-helpers.js?
...
var DependencyWatcher = function (deps, app_dir, on_change) {
  ...
  self.specific_files = {};
  // #PackageOverride use this mechanism to support local package
